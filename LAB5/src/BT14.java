...
public class BT14 extends JFrame {
	...
	public BT14() {
		...
		textFieldURL.setText("https://www.google.com.vn/?hl=vi");
		textFieldURL.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		textFieldURL.setBounds(126, 45, 427, 35);
		contentPane.add(textFieldURL);
		textFieldURL.setColumns(10);
		
		textFieldAuthority = new JTextField();
		textFieldAuthority.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		textFieldAuthority.setBounds(126, 199, 427, 35);
		contentPane.add(textFieldAuthority);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					textFieldAuthority.setText("" + url.getAuthority());
		...
		btnNewButton.setBounds(285, 115, 116, 50);
		...
		btnNewButton_1.setBounds(285, 270, 116, 50);
