...
public class BT7 extends JFrame {
	...
	public BT7() {
		...
		JLabel lblNewLabel_1 = new JLabel("PortNumber:");
		...
		textFieldURL.setBounds(126, 45, 408, 35);
		...
		textFieldPortNumber.setBounds(126, 199, 408, 35);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					textFieldPortNumber.setText("" + url.getPort());
		...
		btnNewButton.setBounds(273, 113, 116, 50);
		...
		btnNewButton_1.setBounds(273, 271, 116, 50);
